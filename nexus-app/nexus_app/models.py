...
class OccupationalAbilityAnalysis(TimestampMixin, Base):
    ...
    # FK to job_demand_dataset is declared as a string in alembic to avoid
    # a Python-import cycle with B4 in this worktree (the table is created
    # by B4 migration before B6 migration runs).
...
class AbilityAnalysisSourceDataset(Base):
    ...
    # FK string-only — see class docstring.
    job_demand_dataset_id: Mapped[str] = mapped_column(String(36), nullable=False)
