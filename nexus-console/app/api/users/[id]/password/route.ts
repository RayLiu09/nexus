/**
 * Route handler: /api/users/:id/password
 *
 * POST → admin-initiated password reset. Body: { password }.
 */
...
export async function POST(request: Request, context: RouteContext): Promise<NextResponse> {
  ...
  const result = await proxy<unknown>(`/internal/v1/users/${encodeURIComponent(id)}/password`, {
    method: "POST",
    body,
