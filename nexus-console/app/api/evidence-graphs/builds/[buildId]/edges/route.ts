import type { KnowledgeGraphEdge } from "@/lib/api";
...
export async function GET(
  ...
  return proxyEvidenceGraphList<KnowledgeGraphEdge>(
    `/internal/v1/knowledge-graphs/builds/${encodeURIComponent(buildId)}/edges`,
    search,
  );
}
