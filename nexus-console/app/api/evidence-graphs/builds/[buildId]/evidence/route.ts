import type { KnowledgeGraphEvidence } from "@/lib/api";
...
export async function GET(
  ...
  return proxyEvidenceGraphList<KnowledgeGraphEvidence>(
    `/internal/v1/knowledge-graphs/builds/${encodeURIComponent(buildId)}/evidence`,
    search,
  );
}
