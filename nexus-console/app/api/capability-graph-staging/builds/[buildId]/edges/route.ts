...
import type { CapabilityGraphStagingEdge } from "@/lib/api";
...
export async function GET(
  ...
  return proxyInternalList<CapabilityGraphStagingEdge>(
    `/internal/v1/capability-graph-staging/builds/${encodeURIComponent(buildId)}/edges`,
    search,
  );
}
