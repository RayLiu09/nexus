...
from nexus_api.api.internal.course_textbooks import router as _course_textbooks_router
...
from nexus_api.api.internal.governance_review import router as _governance_review_router
from nexus_api.api.internal.governance_traces import router as _governance_traces_router
...
from nexus_api.api.internal.knowledge_outline_review import (
...
router.include_router(_course_textbooks_router)
...
router.include_router(_governance_review_router)
router.include_router(_governance_traces_router)
